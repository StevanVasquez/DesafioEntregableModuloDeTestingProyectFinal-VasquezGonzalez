const validationUtils = {
    validateRegisterBody: (body) => {
      if ( !body.first_name || !body.last_name || !body.email || !body.age || !body.password || body.password === "" ) {
        return false;
      } else {
        return true;
      }
    ...
    validateTicketBody: (ticketBody) => {
      if ( !ticketBody.purchaser || !ticketBody.purchase_datetime || !ticketBody.amount) {
        return false;
      } else {
        return true;
      }
